...
public class PostControllerTest {
  ...
  @Test
  @WithAnonymousUser
  void 포트스수정시_로그인하지않은경우() throws Exception {
    String title = "title";
    String body = "body";
  ...
  @Test
  @WithAnonymousUser
  void 포트스수정시_본인이_작성한_글이_아니라면_에러발생() throws Exception {
    String title = "title";
    String body = "body";
  ...
  @Test
  @WithMockUser
  void 포트스수정시_수정하려는_글이_없는경우_에러발생() throws Exception {
    String title = "title";
    String body = "body";
  ...
  @Test
  @WithAnonymousUser
  void 포트스삭제시_작성자와_삭제요청자가_다를경우() throws Exception {
    //mocking
  ...
  @Test
  @WithMockUser
  void 포트스삭제시_삭제하려는_포스트가_존재하지_않을_경우() throws Exception {
    //mocking
